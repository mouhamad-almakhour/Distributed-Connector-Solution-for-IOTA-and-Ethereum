...
sock.on('message', msg => {
    ...
    iota.getBundle(tailTransactionHash)
        .then(bundle => {
            ...
            var data = m.split(";")
            console.log("data received from IOTA: DEVICE NAME " + data[0]+ " VALUE: "+ data[1])
            console.log('Send data to Smart Contract :' )
           storeData(data[0], data[1]); // sotre device data
    //    })

    console.timeEnd("Time-Execution");
    itte++;
    console.log("number of itteration: " + itte);
    console.log('Connector : Data sent as a transaction To mart Contract !');
    console.log('....................................................');
        })
});
